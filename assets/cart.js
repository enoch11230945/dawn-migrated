    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .then((state) => {
        ...
        CartPerformance.measure(`${eventTarget}:paint-updated-sections`, () => {
          ...
          // FIXED v26.0: Use variantId to find item instead of assuming parsedState.items[line - 1].
          // Array index can change if apps/scripts reorder line items.
          const updatedItem = variantId
            ? parsedState.items.find(item => item.variant_id === parseInt(variantId))
