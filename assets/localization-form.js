  ...
  customElements.define(
    ...
    class LocalizationForm extends HTMLElement {
      ...
      filterCountries() {
        ...
        // FIXED v12.0: Counter must START at 0, not at allCountries.length.
        // Original logic was doing total + matches (e.g., 200 + 10 = 210).
        ...
        allCountries.forEach((item) => {
          ...
          if (countryName.indexOf(searchValue) > -1) {
            ...
            // FIXED v12.0: Don't decrement here. Only count visible ones.
          }
        });
